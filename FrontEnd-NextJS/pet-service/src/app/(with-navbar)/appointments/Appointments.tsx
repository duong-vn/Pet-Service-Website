          ...
          >
            ...
            <div className="flex justify-center flex-col lg:flex-row items-start gap-8">
              ...
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700/30 rounded-3xl p-4">
                ...
                <div className="  border bg-purple-900/20 dark:border-purple-700/30 rounded-3xl p-4">
                  <h3 className="font-semibold  mb-2 flex items-center gap-2">
                ...
                {data?.pet && (
                  <div className="bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20 border border-orange-200 dark:border-orange-700/30 rounded-3xl p-4">
                    <h3 className="font-semibold  mb-2 flex items-center gap-2">
