            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              >
                <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed">
                  Tại <span className="font-semibold text-primary-dark dark:text-primary-light">ZOZO</span>, chúng tôi cung cấp dịch vụ chăm sóc thú cưng chuyên nghiệp với:
                </p>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-4">
                    ...
                    <span className="text-gray-700 dark:text-gray-300">
                      <strong className="text-primary-dark dark:text-primary-light">Tắm rửa & tỉa lông</strong> - Sạch sẽ, thơm tho, đẹp lông
                    </span>
                  </li>
                  <li className="flex items-start gap-4">
                    <div className="w-3 h-3 bg-gradient-to-r from-secondary-dark to-primary-light dark:from-secondary-light dark:to-primary-light rounded-full mt-2 flex-shrink-0 shadow-sm"></div>
                    <span className="text-gray-700 dark:text-gray-300">
                      <strong className="text-primary-dark dark:text-primary-light">Cắt móng & spa</strong> - Chăm sóc toàn diện cho thú cưng
                    </span>
                  </li>
                  <li className="flex items-start gap-4">
                    <div className="w-3 h-3 bg-gradient-to-r from-secondary-dark to-primary-light dark:from-secondary-light dark:to-primary-light rounded-full mt-2 flex-shrink-0 shadow-sm"></div>
                    <span className="text-gray-700 dark:text-gray-300">
                      <strong className="text-primary-dark dark:text-primary-light">Đặt lịch trực tuyến</strong> - Chỉ vài thao tác, nhận xác nhận ngay
                    </span>
                  </li>
                </ul>

                <p className="text-lg md:text-xl text-gray-700 dark:text-gray-300 leading-relaxed pt-4">
                  Đội ngũ chuyên nghiệp, tận tâm sẽ chăm sóc thú cưng của bạn như chính con cái trong nhà.
                </p>
              </motion.div>
