  ...
  return (
    ...
    >
      <section className="max-w-6xl mx-auto px-4 py-16">
        <div className="rounded-3xl bg-gradient-to-tl  from-primary-light dark to-background-light dark:from-primary-dark dark:to-background-dark text-white p-8 md:p-12 shadow-2xl flex flex-col md:flex-row items-center gap-6">
